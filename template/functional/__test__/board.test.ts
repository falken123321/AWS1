  ...
  describe("moves", () => {
    ...
    describe("making moves", () => {
      ...
      it("finds single horizontal match when moving first piece to a match", () => {
        generator.prepare("C", "D", "A");
        expect(
          Board.move(generator, board, { row: 2, col: 1 }, { row: 0, col: 1 })
            .effects
        ).toContainEqual({
          kind: "Match",
          match: {
      ...
      it("finds single horizontal match when moving second piece to a match", () => {
        generator.prepare("C", "D", "A");
        expect(
          Board.move(generator, board, { row: 0, col: 1 }, { row: 2, col: 1 })
            .effects
        ).toContainEqual({
          kind: "Match",
          match: {
      ...
      it("finds single vertical match when moving first piece to a match", () => {
        generator.prepare("C", "D", "A");
        expect(
          Board.move(generator, board, { row: 3, col: 3 }, { row: 2, col: 3 })
            .effects
        ).toContainEqual({
          kind: "Match",
          match: {
      ...
      it("finds single vertical match when moving second piece to a match", () => {
        generator.prepare("C", "D", "A");
        expect(
          Board.move(generator, board, { row: 2, col: 3 }, { row: 3, col: 3 })
            .effects
        ).toContainEqual({
          kind: "Match",
          match: {
